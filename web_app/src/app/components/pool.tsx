        ...
        <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start z-10 w-full min-w-[50rem] max-w-4xl">
          <div className="flex justify-between w-full items-center mb-4">
            ...
            <div className="flex space-x-4">
              <button className="bg-[#FE5C5C] flex h-full items-center justify-between gap-[1rem] rounded-xl px-[0.74rem] py-2 text-black hover:opacity-80 transition-opacity duration-300">+ New position</button>
            </div>
          </div>
