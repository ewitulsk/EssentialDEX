...
//     //STATE CHANGES
//     let reserve_usdc = await get_reserve_usdc() + 400
...
//     let amount_out = 0;
//     if (Math.floor((amount_in * reserve_ess) / (reserve_usdc + amount_in))){
//         amount_out = token_in
//     }
//     else{
//         amount_out = (amount_in * reserve_usdc) / (reserve_ess + amount_in)
//     }
